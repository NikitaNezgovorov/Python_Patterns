...
class SmsNotifier(User):

    def update(self, title):
        print('SMS->', 'к нам присоединился', title.students[-1].name)


class EmailNotifier(User):

    def update(self, title):
        print(('EMAIL->', 'к нам присоединился', title.students[-1].name))
